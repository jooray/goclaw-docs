...
| `broadcast` | `text` | Gửi tin nhắn đến tất cả teammate (trừ bản thân); **chỉ lead mới dùng được** |
...
**Lead gửi tin nhắn đến toàn team** (trừ bản thân). Chỉ team lead mới có thể broadcast:
