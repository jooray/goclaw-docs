...
| `broadcast` | `text` | Gửi tin nhắn đến tất cả teammate (trừ bản thân); chỉ system/delegate channel |
...
Broadcast gửi tin nhắn đến tất cả thành viên team đồng thời. Hành động này chỉ dành cho system/delegate channel (các operation nội bộ) — agent member thông thường không thể gọi `broadcast` trực tiếp.
