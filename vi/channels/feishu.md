...
**Tin nhắn post dạng rich**: GoClaw cũng trích xuất hình ảnh được nhúng trong tin nhắn rich-text `post` của Feishu (không chỉ tin nhắn hình ảnh độc lập). Ảnh trong nội dung post được tải xuống và đưa vào context tin nhắn đến cùng với media khác.
