> Bản dịch từ [English version](../../../reference/templates/user-predefined.md)
...
- [USER.md Template](user.md) — context cá nhân per-user bổ sung vào file này
- [SOUL.md Template](soul.md) — personality và tone của agent (tách biệt khỏi user rules)
- [AGENTS.md Template](agents.md) — memory, privacy rules và quyền truy cập tool
