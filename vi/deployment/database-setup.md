> Bản dịch từ [English version](../../deployment/database-setup.md)
...
- [Docker Compose](./docker-compose.md) — deploy theo compose với postgres overlay
- [Security Hardening](./security-hardening.md) — mã hóa AES-256-GCM cho secrets trong database
- [Observability](./observability.md) — query traces và spans để theo dõi chi phí LLM
